...
class VaultTestQueryController(
    ...
    private fun doTestQuery(project: SProject, buildType: SBuildType, properties: Map<String, String>, xmlResponse: Element) {
        ...
        try {
            ...
            val isWriteEngineEnabled = buildType.configParameters[VaultConstants.FeatureFlags.FEATURE_ENABLE_WRITE_ENGINES]?.toBoolean() ?:
                TeamCityProperties.getBoolean(VaultConstants.FeatureFlags.FEATURE_ENABLE_WRITE_ENGINES)
